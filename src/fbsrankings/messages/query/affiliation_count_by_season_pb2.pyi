...
class AffiliationCountBySeasonResult(_message.Message):
    __slots__ = ("query_id", "season_id", "fbs_count", "fcs_count")
    ...
    fbs_count: int
    fcs_count: int
    def __init__(self, query_id: _Optional[str] = ..., season_id: _Optional[str] = ..., fbs_count: _Optional[int] = ..., fcs_count: _Optional[int] = ...) -> None: ...
