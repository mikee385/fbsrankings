...
class GameDto (object):
    def __init__(self, ID: UUID, season_ID: UUID, week: int, date: datetime.date, season_section: str, home_team_ID: UUID, away_team_ID: UUID, home_team_score: Optional[int], away_team_score: Optional[int], status: str, notes: str) -> None:
        self.ID = ID
...
class GameStorage (object):
    ...
    def find(self, season_ID: UUID, week: int, team1_ID: UUID, team2_ID: UUID) -> Optional[GameDto]:
    ...
    def _get_key(self, season_ID: UUID, week: int, team1_ID: UUID, team2_ID: UUID) -> Tuple[UUID, int, UUID, UUID]:
