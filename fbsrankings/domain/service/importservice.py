...
class ImportService (object):
    def __init__(self, repository, validation_service):
    ...
    def import_season(self, year):
        ...
        if season is None:
            ...
            if season is None:
                season = self._repository.season.register(year)
    ...
    def import_team(self, name):
        ...
        if team is None:
            ...
            if team is None:
                team = self._repository.team.register(name)
    ...
    def import_affiliation(self, year, team_name, subdivision):
        ...
        if affiliation is None:
            ...
            if affiliation is None:
                affiliation = self._repository.affiliation.register(season.ID, team.ID, subdivision)
    ...
    def import_game(self, year, week, date_, season_section, home_team_name, away_team_name, home_team_score, away_team_score, status, notes):
        ...
        if game is None:
            ...
            if game is None:
                game = self._repository.game.schedule(season.ID, week, date_, season_section, home_team.ID, away_team.ID, notes)
